    ...
    <div id="page-wrapper">
        <div class="container-fluid">
        	<div class="row">
        		<div class="col-lg-8">
					<h3> </h3>
					<form method="post" action="<?php echo base_url('Times/saveTime') ?>" enctype="multipart/form-data"">
						<fieldset class="form-group">
					  	...
					  	<fieldset class="form-group">
					    	...
					    	<input required autofocus name="NOME" type="password" class="form-control" placeholder="Nome" />
						</fieldset>
						<fieldset class="form-group">
